...
num_files = 4
iters_per_file = 1000
N = 1000000  # Updated to 1e6 based on your C++ code (n = 1e6)
lim_m = 100000000 # 1e8
...
connectivity_points = df[df['cc_count'] == 1]
first_connect = connectivity_points.groupby('iteration')['m'].min()
saturation_m = first_connect.median()  # or mean()
...
# 4. Final Formatting
plt.title(f'Log-Log Phase Transition: n={N}, 4000 Runs', fontsize=16)
